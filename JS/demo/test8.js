...
//start of reconnecting-websocket
...
LOCALSENSE.WEBSOCKET_API = new function () {
        ...
        function getAndsendGrpAccess() {
        	console.log('entered getAndsendGrpAccess');
...
var ws_api = LOCALSENSE.WEBSOCKET_API;
    ...
    function showTagPosBin(val) {
        ...
        console.log("val_show_tag_pos : "+val_show_tag_pos);
...
if (ws_api) {
            ...
            ws_api.onRecvTagPosBin = function (obj) {
                ...
                console.log(showTagPosBin(HEXto16Str(obj)));
            };
