        ...
        this_obj.RequireControlInfo = function (url) {
            try {
                ...
                ws3.onopen = function (event) {
                    ...
                    CallbackRegisterFunc(this_obj.CB_TYPE.ON_OPEN, "Websocket connected");
                };
                ...
                ws3.onclose = function (event) {
                    CallbackRegisterFunc(this_obj.CB_TYPE.ON_CLOSE, "Websocket closed connection");
                };
                ws3.onerror = function (event) {

                    CallbackRegisterFunc(this_obj.CB_TYPE.ON_ERROR, "Websocket disconnected");
                };
            } catch (ex) {
                //alert(ex.message);
            }
...
//local sense class end

//variable inside account info inside getandsendGrpAccess
...
//end of variable inside account info inside getandsendGrpAccess


//start of function callbackregisterFunc
...
//end of function callbackregisterFunc


//start of getandsendGrpAccess function
...
//end of getandsendGrpAccess function


//https://www.npmjs.com/package/websocket   w3c websocket
var W3CWebSocket = require('websocket').w3cwebsocket;

var client = new W3CWebSocket('ws://49.232.114.188:48300/', 'echo-protocol');
